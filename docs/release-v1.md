...
> Este documento conserva la fotografía histórica del cierre V1. El estado activo se mantiene en `README.md` y actualmente corresponde a Aplicación `1.2.0`, Catálogo `0.1.25` y Valheim `0.221.12`.
